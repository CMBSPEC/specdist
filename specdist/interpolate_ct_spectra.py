...
def load_ct_spectra_lib(case,specdist_ct_spectra_lib):
    if case == 'bare':
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_without_collision_190820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 80
        specdist_ct_spectra_lib.Gamma_values = np.logspace(np.log10(specdist_ct_spectra_lib.Gamma_inj_min),np.log10(specdist_ct_spectra_lib.Gamma_inj_max),specdist_ct_spectra_lib.N_Gamma_inj)

        specdist_ct_spectra_lib.x_inj_min = 1e-8
        specdist_ct_spectra_lib.x_inj_max = 1e7
        specdist_ct_spectra_lib.N_x_inj = 300
        specdist_ct_spectra_lib.x_inj_values = np.logspace(np.log10(specdist_ct_spectra_lib.x_inj_min),np.log10(specdist_ct_spectra_lib.x_inj_max),specdist_ct_spectra_lib.N_x_inj)
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_without_collision_stim_070920':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-30
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 160
        specdist_ct_spectra_lib.Gamma_values = np.logspace(np.log10(specdist_ct_spectra_lib.Gamma_inj_min),np.log10(specdist_ct_spectra_lib.Gamma_inj_max),specdist_ct_spectra_lib.N_Gamma_inj)
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_without_collision_high_xinj_160920':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-14
        specdist_ct_spectra_lib.N_Gamma_inj = 40
        specdist_ct_spectra_lib.Gamma_values = np.logspace(np.log10(specdist_ct_spectra_lib.Gamma_inj_min),np.log10(specdist_ct_spectra_lib.Gamma_inj_max),specdist_ct_spectra_lib.N_Gamma_inj)

        specdist_ct_spectra_lib.x_inj_min = 1e4
        specdist_ct_spectra_lib.x_inj_max = 1e7
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_without_collision_high_xinj_160920b':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 80
        ...
        specdist_ct_spectra_lib.x_inj_min = 1e4
        specdist_ct_spectra_lib.x_inj_max = 5e8
        specdist_ct_spectra_lib.N_x_inj = 128
        specdist_ct_spectra_lib.x_inj_values = np.logspace(np.log10(specdist_ct_spectra_lib.x_inj_min),np.log10(specdist_ct_spectra_lib.x_inj_max),specdist_ct_spectra_lib.N_x_inj)
    ...
    elif case == 'extended_run_xe_history_010820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 75
        specdist_ct_spectra_lib.Gamma_values = np.logspace(np.log10(specdist_ct_spectra_lib.Gamma_inj_min),np.log10(specdist_ct_spectra_lib.Gamma_inj_max),specdist_ct_spectra_lib.N_Gamma_inj)

        specdist_ct_spectra_lib.x_inj_min = 1e-8
        specdist_ct_spectra_lib.x_inj_max = 1e7
        specdist_ct_spectra_lib.N_x_inj = 250
        specdist_ct_spectra_lib.x_inj_values = np.logspace(np.log10(specdist_ct_spectra_lib.x_inj_min),np.log10(specdist_ct_spectra_lib.x_inj_max),specdist_ct_spectra_lib.N_x_inj)
    ...
    elif case == 'extended_run_xe_history_Drho_rho_1e-8_160820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-14
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-14
        specdist_ct_spectra_lib.N_Gamma_inj = 1

        specdist_ct_spectra_lib.Gamma_values = [1e-14]
        ...
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-30
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 30

        A = np.logspace(-21,-30,10)
        B = np.logspace(-8,-20,20)
        specdist_ct_spectra_lib.Gamma_values = np.concatenate((B,A))
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_without_collision_20x20_170820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 20
    ...
    elif case == 'extended_run_xe_history_Drho_rho_5e-6_no_collision_160820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-14
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-14
        specdist_ct_spectra_lib.N_Gamma_inj = 1
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_without_collision_20x20_170820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 20
    ...
    elif case == 'extended_run_xe_history_Drho_rho_3e-5_zlate_1e3_with_collision_20x20_170820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = 1e-20
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 20
    ...
    elif case == 'extended_run_xe_history_120820':
        specdist_ct_spectra_lib.case_id = "case_" + case
        specdist_ct_spectra_lib.Gamma_inj_min = np.logspace(-8,-20,80)[75]
        specdist_ct_spectra_lib.Gamma_inj_max = 1e-8
        specdist_ct_spectra_lib.N_Gamma_inj = 76

        specdist_ct_spectra_lib.Gamma_values = np.logspace(np.log10(1e-8),np.log10(1e-20),80)[0:76]
    ...
    if case == 'extended_run_xe_history_120820':
    ...
    # for id_Gamma in range(1):
        ...
        # if case == 'extended_run_xe_history_120820':
        #     x_ct_no_injection = []
        #     filename = specdist_ct_spectra_lib.path_to_spectra + '_no_injection' + '/spectra_' + case + '_no_injection_fine_grid' + '_x_ct.txt'
        #     with open(filename) as f:
        #         for line in f:
        #             ls = line.strip()
        #             if ls:
        ...
        #     filename_no_injection = specdist_ct_spectra_lib.path_to_spectra + '_no_injection' +  '/spectra_'  + case + '_no_injection_fine_grid' +  '_DI_ct.txt'
        #
        #     with open(filename) as f:
        #         for line in f:
        #             ls = line.strip()
        ...
        #
        #     filename_no_injection = specdist_ct_spectra_lib.path_to_spectra + '_no_injection' +  '/spectra_'  + case + '_no_injection_fine_grid' +  '_Xe_values_ct.txt'
        #     with open(filename_no_injection) as f:
        #         for line in f:
        #             ls = line.strip()
        #             if ls:
        ...
        #
        #     filename_no_injection = specdist_ct_spectra_lib.path_to_spectra + '_no_injection' +  '/spectra_'  + case + '_no_injection_fine_grid' +  '_Xe_redshifts_ct.txt'
        #     with open(filename_no_injection) as f:
        #         for line in f:
        #             ls = line.strip()
        #             if ls:
        ...
        if 'xe_history' in case or 'quasistable_particle' in case:
            ...
            for (p,p_no_inj,z,z_no_inj) in zip(Xe_values_ct,Xe_values_no_inj_ct,Xe_redshifts_ct,Xe_redshifts_no_inj_ct):
                ...
                if np.sum(has_nan):
                    ...
                    Xe_no_inj_p = np.empty(len(p))
                    Xe_no_inj_p[:] = np.nan

                else:
                    f_Xe = interp1d(np.asarray(z), np.asarray(p),bounds_error=False,fill_value=1e-300)
                    f_Xe_no_inj = interp1d(np.asarray(z_no_inj), np.asarray(p_no_inj),bounds_error=False,fill_value=1e-300)
                    ...
                    Xe_p = new_Xe
                    Xe_no_inj_p = new_Xe_no_inj


                Xe.append(Xe_p)
                Xe_no_inj.append(Xe_no_inj_p)

                DXe_Xe.append(DXe_Xe_p)
                DXe_Xe_redshifts.append(DXe_Xe_redshifts_p)

            specdist_ct_spectra_lib.Xe_2d.append(Xe)
            specdist_ct_spectra_lib.Xe_no_inj_2d.append(Xe_no_inj)
...
def GetXeHistory(Gamma_inj_asked,x_inj_asked,z_asked,specdist_ct_spectra_lib,omega_cdm=0.12,fdm_asked=0,get_pca_constraint='yes'):
    ...
    if (r1 < 0) or (r2 < 0) or (r3 < 0) or (r4 < 0):
        ...
        Xe_2d = specdist_ct_spectra_lib.Xe_2d
        Xe_no_inj_2d = specdist_ct_spectra_lib.Xe_no_inj_2d
        ...
        Xe = [[Xe_redshifts_2d[id_gamma_low][id_xinj_low],Xe_2d[id_gamma_low][id_xinj_low]],
                  [Xe_redshifts_2d[id_gamma_low][id_xinj_high],Xe_2d[id_gamma_low][id_xinj_high]],
                  [Xe_redshifts_2d[id_gamma_high][id_xinj_low],Xe_2d[id_gamma_high][id_xinj_low]],
                  [Xe_redshifts_2d[id_gamma_high][id_xinj_high],Xe_2d[id_gamma_high][id_xinj_high]]]


        Xe_no_inj = [[Xe_redshifts_2d[id_gamma_low][id_xinj_low],Xe_no_inj_2d[id_gamma_low][id_xinj_low]],
                  [Xe_redshifts_2d[id_gamma_low][id_xinj_high],Xe_no_inj_2d[id_gamma_low][id_xinj_high]],
                  [Xe_redshifts_2d[id_gamma_high][id_xinj_low],Xe_no_inj_2d[id_gamma_high][id_xinj_low]],
                  [Xe_redshifts_2d[id_gamma_high][id_xinj_high],Xe_no_inj_2d[id_gamma_high][id_xinj_high]]]
        ...
        S_Xe_gamma_low_xinj_low = S_Xe[0]
        S_Xe_gamma_low_xinj_high = S_Xe[1]
        S_Xe_gamma_high_xinj_low = S_Xe[2]
        S_Xe_gamma_high_xinj_high = S_Xe[3]

        S_Xe_no_inj_gamma_low_xinj_low = S_Xe_no_inj[0]
        S_Xe_no_inj_gamma_low_xinj_high = S_Xe_no_inj[1]
        S_Xe_no_inj_gamma_high_xinj_low = S_Xe_no_inj[2]
        S_Xe_no_inj_gamma_high_xinj_high = S_Xe_no_inj[3]
        ...
        Arrays_list = [S_gamma_low_xinj_low,
                      ...
                      S_gamma_high_xinj_high]
        #
        # Arrays_list_Xe = [S_Xe_gamma_low_xinj_low,
        #                   S_Xe_gamma_low_xinj_high,
        #                   S_Xe_gamma_high_xinj_low,
        #                   S_Xe_gamma_high_xinj_high]
        #
        # Arrays_list_Xe_no_inj =  [S_Xe_no_inj_gamma_low_xinj_low,
        #                           S_Xe_no_inj_gamma_low_xinj_high,
        #                           S_Xe_no_inj_gamma_high_xinj_low,
        #                           S_Xe_no_inj_gamma_high_xinj_high]
        ...
        if np.sum(has_nan):
            ...
            array_S_result = np.empty(len(x_asked))
            array_S_result[:] =  np.nan
            array_S_Xe_result = np.empty(len(x_asked))
            array_S_Xe_result[:] =  np.nan
            array_S_Xe_no_inj_result = np.empty(len(x_asked))
            array_S_Xe_no_inj_result[:] =  np.nan
            F_gamma_asked_xinj_asked = np.nan
        else:
            nx = int(1e4)
            ...
            f_Xe_gamma_low = interp1d(S_Xe_gamma_low_xinj_low[0], S_Xe_gamma_low_xinj_low[1])
            f_Xe_gamma_high = interp1d(S_Xe_gamma_high_xinj_low[0], S_Xe_gamma_high_xinj_low[1])

            f_Xe_no_inj_gamma_low = interp1d(S_Xe_no_inj_gamma_low_xinj_low[0], S_Xe_no_inj_gamma_low_xinj_low[1])
            f_Xe_no_inj_gamma_high = interp1d(S_Xe_no_inj_gamma_high_xinj_low[0], S_Xe_no_inj_gamma_high_xinj_low[1])


            new_S_gamma_low = f_gamma_low(new_x_array)
            new_S_gamma_high = f_gamma_high(new_x_array)

            new_S_Xe_gamma_low = f_Xe_gamma_low(new_x_array)
            new_S_Xe_gamma_high = f_Xe_gamma_high(new_x_array)

            new_S_Xe_no_inj_gamma_low = f_Xe_no_inj_gamma_low(new_x_array)
            new_S_Xe_no_inj_gamma_high = f_Xe_no_inj_gamma_high(new_x_array)
            ...
            new_S_Xe_gamma_asked = w*new_S_Xe_gamma_low + (1.-w)*new_S_Xe_gamma_high
            new_S_Xe_no_inj_gamma_asked = w*new_S_Xe_no_inj_gamma_low + (1.-w)*new_S_Xe_no_inj_gamma_high
#             print('xinj _low : w_gamma = %.14e'%w)
            ...
            S_Xe_gamma_asked_xinj_low = [[],[]]
            S_Xe_gamma_asked_xinj_low[0] = new_x_array
            S_Xe_gamma_asked_xinj_low[1] = new_S_Xe_gamma_asked

            S_Xe_no_inj_gamma_asked_xinj_low = [[],[]]
            S_Xe_no_inj_gamma_asked_xinj_low[0] = new_x_array
            S_Xe_no_inj_gamma_asked_xinj_low[1] = new_S_Xe_no_inj_gamma_asked
            ...
            f_Xe_gamma_low = interp1d(S_Xe_gamma_low_xinj_high[0], S_Xe_gamma_low_xinj_high[1])
            f_Xe_gamma_high = interp1d(S_Xe_gamma_high_xinj_high[0], S_Xe_gamma_high_xinj_high[1])

            f_Xe_no_inj_gamma_low = interp1d(S_Xe_no_inj_gamma_low_xinj_high[0], S_Xe_no_inj_gamma_low_xinj_high[1])
            f_Xe_no_inj_gamma_high = interp1d(S_Xe_no_inj_gamma_high_xinj_high[0], S_Xe_no_inj_gamma_high_xinj_high[1])
...
#             print('xinj _high : w_gamma = %.14e'%w)
            ...
            S_Xe_gamma_asked_xinj_high = [[],[]]
            S_Xe_gamma_asked_xinj_high[0] = new_x_array
            S_Xe_gamma_asked_xinj_high[1] = new_S_Xe_gamma_asked

            S_Xe_no_inj_gamma_asked_xinj_high = [[],[]]
            S_Xe_no_inj_gamma_asked_xinj_high[0] = new_x_array
            S_Xe_no_inj_gamma_asked_xinj_high[1] = new_S_Xe_no_inj_gamma_asked
            ...
            f_Xe_xinj_low = interp1d(S_Xe_gamma_asked_xinj_low[0], S_Xe_gamma_asked_xinj_low[1])
            f_Xe_xinj_high = interp1d(S_Xe_gamma_asked_xinj_high[0], S_Xe_gamma_asked_xinj_high[1])

            new_S_Xe_xinj_low = f_Xe_xinj_low(new_x_array)
            new_S_Xe_xinj_high = f_Xe_xinj_high(new_x_array)

            f_Xe_no_inj_xinj_low = interp1d(S_Xe_no_inj_gamma_asked_xinj_low[0], S_Xe_no_inj_gamma_asked_xinj_low[1])
            f_Xe_no_inj_xinj_high = interp1d(S_Xe_no_inj_gamma_asked_xinj_high[0], S_Xe_no_inj_gamma_asked_xinj_high[1])

            new_S_Xe_no_inj_xinj_low = f_Xe_no_inj_xinj_low(new_x_array)
            new_S_Xe_no_inj_xinj_high = f_Xe_no_inj_xinj_high(new_x_array)
...
#             print('w_xinj = %.14e'%w)
            ...
            new_S_xinj_asked = w*new_S_xinj_low + (1.-w)*new_S_xinj_high
            new_S_Xe_xinj_asked = w*new_S_Xe_xinj_low + (1.-w)*new_S_Xe_xinj_high
            new_S_Xe_no_inj_xinj_asked = w*new_S_Xe_no_inj_xinj_low + (1.-w)*new_S_Xe_no_inj_xinj_high
            ...
            S_Xe_gamma_asked_xinj_asked = [[],[]]
            S_Xe_gamma_asked_xinj_asked[0] = new_x_array
            S_Xe_gamma_asked_xinj_asked[1] = new_S_Xe_xinj_asked

            S_Xe_no_inj_gamma_asked_xinj_asked = [[],[]]
            S_Xe_no_inj_gamma_asked_xinj_asked[0] = new_x_array
            S_Xe_no_inj_gamma_asked_xinj_asked[1] = new_S_Xe_no_inj_xinj_asked

            F_gamma_asked_xinj_asked = w*F_gamma_asked_xinj_low + (1.-w)*F_gamma_asked_xinj_high


            f_gamma_asked_xinj_asked = interp1d(S_gamma_asked_xinj_asked[0], S_gamma_asked_xinj_asked[1])
            f_Xe_gamma_asked_xinj_asked = interp1d(S_Xe_gamma_asked_xinj_asked[0], S_Xe_gamma_asked_xinj_asked[1])
            f_Xe_no_inj_gamma_asked_xinj_asked = interp1d(S_Xe_no_inj_gamma_asked_xinj_asked[0], S_Xe_no_inj_gamma_asked_xinj_asked[1])
            ########### get spectra at required x values
            bound_x_min = np.min(S_gamma_asked_xinj_asked[0])
            bound_x_max = np.max(S_gamma_asked_xinj_asked[0])
            ...
            array_S_result = f_gamma_asked_xinj_asked(array_x_asked)
            array_S_Xe_result = f_Xe_gamma_asked_xinj_asked(array_x_asked)
            array_S_Xe_no_inj_result = f_Xe_no_inj_gamma_asked_xinj_asked(array_x_asked)
    ...
    if get_pca_constraint == 'yes':
        ...
        f = interp1d(array_x_asked, array_S_result,bounds_error=False, fill_value=0.)
        ...
        zeta1 = f(new_z1) #DXe_Xe @ z1
        zeta2 = f(new_z2) #DXe_Xe @ z2
        zeta3 = f(new_z3) #DXe_Xe @ z3
        ...
        min_norm = 0.5
        if LA.norm(zeta1) < min_norm or LA.norm(zeta2) < min_norm  or LA.norm(zeta3) < min_norm :
            fdm_pca_lim = np.nan
        else:
